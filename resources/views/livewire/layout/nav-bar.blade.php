            ...
            <x-dropdown align="right" width="48">
                ...
                <x-slot name="content">
                    ...
                    @if(auth()->user()->admin)
                        ...
                        <x-dropdown-link href="{{ route('under-construction') }}">Users (advanced)</x-dropdown-link>
                        <x-dropdown-link href="{{ route('under-construction') }}">Users (expert)</x-dropdown-link>
                        <div class="border-t border-gray-100"></div>
